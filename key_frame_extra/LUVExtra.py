...
videopath = r"E:\Retrievl\ReadVideo\key_frame_extra\PeakDetect\acrobacia.mp4"

#Directory to store the processed frames
# dir = sys.argv[2]
dir = "../tmp_data/tmp_video/"
...
while (ret):
    ...
    if curr_frame is not None and prev_frame is not None:
        # logic here
        diff = cv2.absdiff(curr_frame, prev_frame)# 计算当前帧与前一帧之间的绝对差异
        count = np.sum(diff) # 计算差异图像的所有像素值之和
